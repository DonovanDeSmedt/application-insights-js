...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        ...
        (function (_InternalMessageId) {
            ...
            _InternalMessageId[_InternalMessageId["OperationIdInvalid"] = 67] = "OperationIdInvalid";
            _InternalMessageId[_InternalMessageId["IdTooLong"] = 68] = "IdTooLong";
    ...
    (function (ApplicationInsights) {
        ...
        (function (Context) {
            ...
            var Operation = /** @class */ (function () {
                 ...
                 */
                Operation.prototype.setCustomId = function (id) {
                    this.id = id;
                 ...
                 */
                Operation.prototype.resetCustomId = function () {
                    this.id = null;
...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        ...
        var AppInsights = /** @class */ (function () {
             ...
             */
            AppInsights.prototype.setCustomOperationId = function (operationId) {
                try {
                    this.context.operation.setCustomId(operationId);
                }
                catch (e) {
                    ApplicationInsights._InternalLogging.throwInternal(ApplicationInsights.LoggingSeverity.WARNING, ApplicationInsights._InternalMessageId.OperationIdInvalid, 'override operation id failed, fallback to default operation id: ' + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) });
                }
            };
            /**
             * Stop using custom operation id, continue using default operation id
             */
            AppInsights.prototype.resetCustomOperationId = function () {
                try {
                    this.context.operation.resetCustomId();
                }
                catch (e) {
                    ApplicationInsights._InternalLogging.throwInternal(ApplicationInsights.LoggingSeverity.WARNING, ApplicationInsights._InternalMessageId.OperationIdInvalid, 'reset custom operation id failed, fallback to default operation id: ' + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) });
                }
            };
            /**
            ...
            AppInsights.prototype._onerror = function (message, url, lineNumber, columnNumber, error) {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternal(ApplicationInsights.LoggingSeverity.CRITICAL, ApplicationInsights._InternalMessageId.ExceptionWhileLoggingError, '_onerror threw exception while logging error, error will not be collected: ' +
                        ApplicationInsights.Util.getExceptionName(exception), { exception: exceptionDump, errorString: errorString });
                }
            };
            return AppInsights;
        }());

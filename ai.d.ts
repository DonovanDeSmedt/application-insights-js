...
declare module Microsoft.ApplicationInsights {
    interface IAppInsights {
        ...
        /**
         * Override default operationId
         * @param operationId A custom operationId string
         */
        setCustomOperationId(operationId: string): any;
        /**
         * Stop using custom operation id
         */
        resetCustomOperationId(): any;
        /**
...
declare module Microsoft.ApplicationInsights {
    ...
    class AppInsights implements IAppInsightsInternal, IAppInsights {
        ...
        /**
         * Override default operationId
         * @param operationId string A customer operationId string
         */
        setCustomOperationId(operationId: string): void;
        /**
         * Stop using custom operation id, continue using default operation id
         */
        resetCustomOperationId(): void;
        /**
         * Logs that a page or other item was viewed.
         * @param   name  The string you used as the name in startTrackPage. Defaults to the document title.
         * @param   url   String - a relative or absolute URL that identifies the page or other item. Defaults to the window location.
